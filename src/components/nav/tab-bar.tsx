...
// home indicator. Hidden from 1024px up.
export const TabBar = () => {
          ...
          return (
            <li key={href}>
              <Link
                ...
                className={`flex min-h-16 flex-col items-center justify-center gap-1 text-xs font-medium transition-colors duration-150 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-focus ${
                  active ? 'text-focus' : 'text-muted active:text-ink-2'
                }`}
              >
